...
export default function BlockedWorkers() {
  return (
    <div className="max-w-2xl mx-auto animate-fade-in">
      <h1 className="font-display text-2xl font-bold text-ink-900 mb-6">Blocked Workers</h1>
      <div className="card-premium p-10 text-center">
        ...
        <h3 className="font-semibold text-ink-900">Blocked worker management is coming soon</h3>
