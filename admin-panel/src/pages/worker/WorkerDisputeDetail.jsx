...
export default function WorkerDisputeDetail() {
  const { id } = useParams();
  ...
  if (error || !dispute) {
    return (
      <div className="py-20 text-center">
        ...
        <Link to="/worker/disputes" className="inline-flex items-center gap-1.5 mt-4 text-sm font-semibold text-brand-700 hover:underline">
  ...
  return (
    <div className="max-w-3xl mx-auto animate-fade-in">
      <Link to="/worker/disputes" className="inline-flex items-center gap-1.5 text-sm font-medium text-gray-500 hover:text-brand-700 mb-5">
        ...
        <div className="flex items-center justify-between px-6 py-4 bg-gradient-to-r from-orange-50 to-amber-50 border-b border-orange-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">Customer: {booking?.customer?.fullName}</p>
            </div>
          </div>
